...
# Define LoRA configuration for maximum efficiency
lora_config = LoraConfig(
    ...
    lora_dropout=0.1, # Lower dropout for efficiency
...
optimizer = AdamW(model.parameters(), lr=5e-4)  # Slightly higher learning rate for faster convergence
...
# Save the model (only LoRA adapters and classification head)
model.save_pretrained("bert-lora-agnews")